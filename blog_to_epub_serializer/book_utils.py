...
class Chapter:
    ...
    def _create_eimg(self, image_path: str) -> None:
        ...
        try:
            ...
            # Optionally, you can log the warning instead of printing it
            logger.warning(f"Error processing image at {image_path}: {e}")
            # Skip adding the image to the list and continue processing other images
            pass
